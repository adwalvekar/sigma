...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./linkable/style.css">
	<title>Head Login|IECSE Sigma</title>
...
.demo-layout-transparent {
  background: url('./loadable/head.png') center / cover;
}
  ...
  <header class="mdl-layout__header mdl-layout__header--transparent">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation">
        ...
        <a class="mdl-navigation__link" href="index.php">General Login</a>
      </nav>
    </div>
  </header>
